        ...
        switch (_a.label) {
            case 0:
                ...
                if (connection.readyState === 1)
                    return [2 /*return*/];
                return [4 /*yield*/, mongoose_1.default.connect("mongodb+srv://arbor0711:123!@#qwe@cluster1.alhxoig.mongodb.net/dashboard?retryWrites=true&w=majority")];
            case 1:
                db = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                throw new Error("Mongo connection failed -" + error_1);
